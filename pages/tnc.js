  ...
  return (
    <div className="p-2">
      ...
      <p>
        ...
        features and it could mean that the AutoBSE app won’t work properly or
        at all.
      </p>{" "}
      <div>
        <p>
      ...
      <p>
        ...
        to us so that we can make it available to you. Automax Solutions India
        Pvt. Ltd. accepts no liability for any loss, direct or indirect, you
      ...
      <p>
        ...
        updates if you want to keep using the app. Automax Solutions India Pvt.
        Ltd. does not promise that it will always update the app so that it is

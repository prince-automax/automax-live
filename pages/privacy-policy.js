...
export default function Contact() {
  return (
    <div className="max-w-7xl   my-2 sm:mx-auto mx-2  overflow-hidden rounded-xl md:rounded-none   border ">
      <p className="font-poppins w-full h-16 font-medium text-xl sm:text-2xl  text-[#FFFFFF] flex items-center pl-4 bg-gradient-to-r from-[#175994] to-[#70BAFC]">
        Privacy & Policy
      </p>

      <div className="w-full p-4 text-[12px] sm:text-base  space-y-4 font-roboto ">
        <div>
          <p className="text-[#717171]">
            Automax Solutions India Pvt. Ltd. built the AutoBSE app as a Free
            app. This SERVICE is provided by Automax Solutions India Pvt. Ltd.
            ...
            and Conditions, which are accessible at AutoBSE unless otherwise
        ...
        <div className="space-y-1 ">
          ...
          <p className="p-px text-[#717171]">
            For a better experience, while using our Service, we may require you
            to provide us with certain personally identifiable information,
            including but not limited to user name, address, email, phone
            number. The information that we request will be retained by us and
            used as described in this privacy policy. The app does use
            third-party services that may collect information used to identify
            you. Link to the privacy policy of third-party service providers
            used by the app
          </p>{" "}
        ...
        <div className="space-y-1">
          <p>
            <strong className="privacy">Log Data</strong>
          </p>{" "}
          <p className="text-[#717171]">
        ...
        <div className="space-y-1">
          <p>
          <strong className="privacy">Cookies</strong>
          </p>{" "}
          <p className="text-[#717171]">
        ...
        <div className="space-y-1">
          <p>
          <strong className="privacy">Service Providers</strong>
          </p>{" "}
          <p className="text-[#717171]">
            We may employ third-party companies and individuals due to the
            following reasons:
          </p>{" "}
          <ul className="list-disc pl-4 text-[#717171] ">
        ...
        <div className="space-y-1">
          <p>
            <strong className="privacy">Security</strong>
          </p>{" "}
          <p className="text-[#717171]">
        ...
        <div className="space-y-1">
          <p>
            <strong className="privacy">Links to Other Sites</strong>
          </p>
          <p className="text-[#717171]">
        ...
        <div className="space-y-1">
          <p>
          <strong className="privacy">Children’s Privacy</strong>
          </p>{" "}
          <p className="text-[#717171]">
        ...
        <div className="space-y-1">
          <p>
          <strong className="privacy">Changes to This Privacy Policy</strong>
          </p>{" "}
          <p className="text-[#717171]">
          ...
          <p>This policy is effective as of 2023-01-02</p>{" "}
        </div>


        <div className="space-y-1">
          <p>
          <strong className="privacy">Contact Us</strong>
          </p>{" "}
          <p className="text-[#717171]">

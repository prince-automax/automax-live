import { CashIcon, CheckIcon, CursorClickIcon, ReceiptRefundIcon } from '@heroicons/react/outline'
                                    ...
                                    <div className="flex-1 flex flex-col">
                                        <div className="bg-white px-6 py-10">
                                            <div>
                                                ...
                                                <p className="block w-full text-center font-bold rounded-lg border border-transparent bg-white px-6 py-3 text-base  text-black hover:bg-gray-50">Automax Solutions India Pvt. Ltd.</p>
                                        ...
                                        />
                                            {/* <div className="mt-8">
                                                ...
                                                <Link href="/register">
                                                    ...
                                                    <p className="block w-full text-center font-bold rounded-lg border border-transparent bg-white px-6 py-3 text-base  text-indigo-600 hover:bg-gray-50">Automax solutions India Pvt Ltd</p>
                                                </div>
                                            </div> */}
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-4 flex items-center justify-center">
                                                <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900 sm:text-6xl">
                                                    <span className="mt-2 mr-2 text-4xl font-medium">Rs.</span>
                                ...
                                <div className="h-full flex flex-col rounded-lg shadow-lg overflow-hidden lg:rounded-none lg:rounded-l-lg">
                                    <div className="flex-1 flex flex-col">
                                        ...
                                        <div className="flex-1 flex flex-col justify-between border-t-2 border-gray-100 p-6 bg-gray-50 sm:p-10 lg:p-6 xl:p-10">
                                            ...
                                            <p className="block w-full text-center font-semibold rounded-lg px-6 py-3 text-base  text-red-600 ">* Please ensure the bank details before proceeding the payment.</p>

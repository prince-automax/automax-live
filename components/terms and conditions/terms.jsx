  ...
  return (
   ...
   Indemnity / Bond / Undertaking if demanded by Seller will have to be fulfilled by Bidder / Buyer.</li>
        ...
        <div className="flex justify-center gap-8">
          <button onClick={acceptTerms} className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-800">Accept</button>
          <a href="/open-auctions/" onClick={rejectTerms}  className="px-4 py-2 bg-gray-400  text-white rounded hover:bg-gray-600">Reject</a>
        </div>
      </div>
    </div>
  )
